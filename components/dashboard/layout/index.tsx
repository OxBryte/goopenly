...
export default function DashboardPageLayout({
  ...
  return (
    <div className="flex flex-col relative w-full gap-1 min-h-screen">
      <div className="flex items-center lg:items-baseline gap-2.5 md:gap-4 px-4 md:px-6 py-3 md:pb-4 lg:pt-7 ring-2 ring-border sticky top-header-mobile lg:top-0 bg-background z-10">
      ...
      <div className="min-h-full flex-1 flex flex-col gap-8 md:gap-14 px-3 lg:px-6 py-6 md:py-10 ring-2 ring-border bg-background">
        {children}
      </div>
    </div>
  );
